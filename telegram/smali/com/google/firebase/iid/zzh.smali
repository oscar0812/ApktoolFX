...
# instance fields
.field private final zzckp:Landroid/content/Intent;

.field private final zzckq:Ljava/util/concurrent/ScheduledExecutorService;

.field private final zzckr:Ljava/util/Queue;
...
.field private zzcks:Lcom/google/firebase/iid/zzf;
...
.method private constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/zzh;->zzckr:Ljava/util/Queue;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/google/firebase/iid/zzh;->zzckt:Z

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v0

    iput-object v0, p0, Lcom/google/firebase/iid/zzh;->zzqD:Landroid/content/Context;

    new-instance v0, Landroid/content/Intent;

    invoke-direct {v0, p2}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    iget-object v1, p0, Lcom/google/firebase/iid/zzh;->zzqD:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/zzh;->zzckp:Landroid/content/Intent;

    iput-object p3, p0, Lcom/google/firebase/iid/zzh;->zzckq:Ljava/util/concurrent/ScheduledExecutorService;

    return-void
.end method

.method private final declared-synchronized zzJO()V
    .locals 4
    ...
    const-string/jumbo v2, "flush queue called"

    invoke-static {v0, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    :cond_0
    :goto_0
    iget-object v0, p0, Lcom/google/firebase/iid/zzh;->zzckr:Ljava/util/Queue;
    ...
    const-string/jumbo v2, "found intent to be delivered"

    invoke-static {v0, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    :cond_1
    iget-object v0, p0, Lcom/google/firebase/iid/zzh;->zzcks:Lcom/google/firebase/iid/zzf;
    ...
    const-string/jumbo v2, "binder is alive, sending the intent."
    ...
    iget-object v2, p0, Lcom/google/firebase/iid/zzh;->zzcks:Lcom/google/firebase/iid/zzf;
    ...
    const-string/jumbo v2, "EnhancedIntentService"

    iget-boolean v0, p0, Lcom/google/firebase/iid/zzh;->zzckt:Z
    ...
    iget-object v2, p0, Lcom/google/firebase/iid/zzh;->zzckp:Landroid/content/Intent;
    ...
    const-string/jumbo v1, "EnhancedIntentService"
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    iput-object p2, p0, Lcom/google/firebase/iid/zzh;->zzcks:Lcom/google/firebase/iid/zzf;
    ...
    :cond_0
    invoke-direct {p0}, Lcom/google/firebase/iid/zzh;->zzJO()V
...
.method public final declared-synchronized zza(Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;)V
    ...
    iget-object v2, p0, Lcom/google/firebase/iid/zzh;->zzckq:Ljava/util/concurrent/ScheduledExecutorService;
