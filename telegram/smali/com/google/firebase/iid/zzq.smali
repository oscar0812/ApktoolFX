...
# static fields
.field private static zzckM:Lcom/google/firebase/iid/zzq;


# instance fields
.field private final zzckN:Landroid/support/v4/util/SimpleArrayMap;
...
.field private zzckO:Ljava/lang/Boolean;

.field final zzckP:Ljava/util/Queue;
...
.field private zzckQ:Ljava/util/Queue;
    .annotation build Landroid/support/annotation/VisibleForTesting;
    .end annotation
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/firebase/iid/zzq;->zzckN:Landroid/support/v4/util/SimpleArrayMap;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/firebase/iid/zzq;->zzckO:Ljava/lang/Boolean;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzq;->zzckP:Ljava/util/Queue;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/iid/zzq;->zzckQ:Ljava/util/Queue;

    return-void
.end method

.method public static declared-synchronized zzJX()Lcom/google/firebase/iid/zzq;
    .locals 2
    ...
    :try_start_0
    sget-object v0, Lcom/google/firebase/iid/zzq;->zzckM:Lcom/google/firebase/iid/zzq;
    ...
    sput-object v0, Lcom/google/firebase/iid/zzq;->zzckM:Lcom/google/firebase/iid/zzq;
...
.method private final zzf(Landroid/content/Context;Landroid/content/Intent;)I
    ...
    iget-object v1, p0, Lcom/google/firebase/iid/zzq;->zzckN:Landroid/support/v4/util/SimpleArrayMap;

    monitor-enter v1

    :try_start_0
    iget-object v0, p0, Lcom/google/firebase/iid/zzq;->zzckN:Landroid/support/v4/util/SimpleArrayMap;
    ...
    :goto_0
    :try_start_1
    iget-object v0, p0, Lcom/google/firebase/iid/zzq;->zzckO:Ljava/lang/Boolean;
    ...
    :try_start_3
    iget-object v3, p0, Lcom/google/firebase/iid/zzq;->zzckN:Landroid/support/v4/util/SimpleArrayMap;
    ...
    const-string/jumbo v4, "Restricting intent to a specific service: "
...
# virtual methods
.method public final zzJY()Landroid/content/Intent;
    .locals 1

    iget-object v0, p0, Lcom/google/firebase/iid/zzq;->zzckQ:Ljava/util/Queue;
...
.method public final zza(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;)I
    ...
    const-string/jumbo v2, "Unknown service action: "
    ...
    :pswitch_0
    iget-object v0, p0, Lcom/google/firebase/iid/zzq;->zzckP:Ljava/util/Queue;
